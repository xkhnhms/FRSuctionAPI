from FRSuctionAPI.algo_tf.infer_obb import Solve_Suciton_Pose
import time
...
if __name__ == "__main__":
    ...
    t1 =time.time()
    suction_pose_solver.solve(rgb_path=local_rgb_path,depth_path=local_depth_path,is_vis=True) # False
    t2 =time.time()
